export const YellowBgButton = ({ text = "text" }) => {
  return (
    <button className="bg-yColor text-black font-semibold py-2 px-5 rounded-md text-lg transition-all duration-150 border border-yColor hover:bg-opacity-90">
      {text}
    </button>
  )
}
...
export const BorderButton = ({ text = "text" }) => {
  return (
    <button className="border border-yColor font-medium py-2 px-5 rounded-md text-lg hover:bg-gray-50 hover:bg-opacity-10 transition-all duration-150">
      {text}
    </button>
  )
}
...
export const ViewButton = ({ text }) => {
  return (
    <h1 className="bg-yColor py-1 rounded-lg  font-semibold border border-yColor transition w-72  duration-200 cursor-pointer text-[1.2rem] text-black group flex justify-center items-center gap-1">
      {text}
